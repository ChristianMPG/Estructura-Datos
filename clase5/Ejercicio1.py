...
print("buscando dato")
#lista.buscar_elemento(10) con print 


#si quiero hacerlo con return, cambio los print por return
#y a la hora de ejecutarlo hago lo siguiente:

variable = lista.buscar_elemento(10)
print(variable)
